...
//        mAdapter.notifyDataSetChanged();
    ...
    public void card(){
        ...
        Log.d("pass", "card");
        mCardList.add(new weather_card("weather", "York", 25, R.drawable.weather_sunny));
        mCardList.add(new tester_card ("card","Ted Ted", "Default Subtitle goes here", "A great get together with my many brothers! waaaaa", R.drawable.tedted, R.drawable.tedtedparty));
        mCardList.add(new tester_card ("card","Ted Ted", "Default Subtitle goes here, more words, more words", "Wheeeeeeee", R.drawable.tedted, R.drawable.sunset));
